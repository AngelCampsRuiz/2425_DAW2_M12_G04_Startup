...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-r from-primary/20 to-primary">
    <div class="bg-white rounded-lg shadow-xl p-4 sm:p-8 lg:px-12 lg:py-8 xl:py-10 w-full max-w-2xl xl:max-w-3xl mx-2 sm:mx-auto">
        <div class="flex flex-col md:flex-row items-center mb-8">
            {{-- LOGO DE LA EMPRESA --}}
            <div class="mb-6 md:mb-0 md:mr-6 flex-shrink-0">
                <a href="{{ url('/') }}">
                    <img src="{{ asset('assets/images/logo.svg') }}" alt="Logo" class="h-48 mx-auto md:mx-0">
                </a>
            </div>
