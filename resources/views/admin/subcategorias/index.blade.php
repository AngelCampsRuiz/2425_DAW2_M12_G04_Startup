...
<div class="container mx-auto px-4 py-6">
    ...
    <!-- Botón flotante de añadir para versión móvil -->
    <div class="fixed bottom-6 right-6 md:hidden">
        <button type="button" class="btn-crear bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-3 rounded-full shadow-lg transition duration-300 flex items-center justify-center" aria-label="Añadir">
