        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse ($publicaciones as $publicacion)
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $publicacion->id }}</td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-gray-900">{{ $publicacion->titulo }}</div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            <div>{{ $publicacion->categoria->nombre_categoria ?? 'N/A' }}</div>
                            <div class="text-xs">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $publicacion->horas_totales }}</td>
