...
<head>
    ...
    <!-- Pusher y script de notificaciones - NO cargar en páginas de solicitudes -->
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
                        ...
                        <nav>
                            <ul class="space-y-2">
                                ...
                                <li><a href="{{ route('institucion.estudiantes.index') }}" class="flex items-center p-2 {{ request()->routeIs('institucion.estudiantes.*') ? 'bg-gradient-to-r from-purple-50 to-purple-100 text-purple-700 border-l-4 border-purple-600' : 'text-gray-700 hover:bg-gray-50' }} rounded-lg transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3 {{ request()->routeIs('institucion.estudiantes.*') ? 'text-purple-600' : 'text-gray-500' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <li><a href="{{ route('institucion.convenios.index') }}" class="flex items-center p-2 {{ request()->routeIs('institucion.convenios.*') || request()->routeIs('convenios.*') ? 'bg-gradient-to-r from-purple-50 to-purple-100 text-purple-700 border-l-4 border-purple-600' : 'text-gray-700 hover:bg-gray-50' }} rounded-lg transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3 {{ request()->routeIs('institucion.convenios.*') || request()->routeIs('convenios.*') ? 'text-purple-600' : 'text-gray-500' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
