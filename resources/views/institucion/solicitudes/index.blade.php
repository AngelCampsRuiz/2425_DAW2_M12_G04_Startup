...
<div class="bg-gray-50 p-6 rounded-xl shadow-sm">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border border-l-4 border-l-yellow-500 hover:shadow-md transition-all">
            ...
            <div class="mt-4">
                <a href="{{ route('institucion.solicitudes.index', ['estado' => 'pendiente']) }}" class="inline-flex items-center text-sm font-medium text-yellow-600 hover:text-yellow-800">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border border-l-4 border-l-green-500 hover:shadow-md transition-all">
            ...
            <div class="mt-4">
                <a href="{{ route('institucion.solicitudes.index', ['estado' => 'aprobada']) }}" class="inline-flex items-center text-sm font-medium text-green-600 hover:text-green-800">
                    Ver detalle <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg>
                </a>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border border-l-4 border-l-red-500 hover:shadow-md transition-all">
            ...
            <div class="mt-4">
                <a href="{{ route('institucion.solicitudes.index', ['estado' => 'rechazada']) }}" class="inline-flex items-center text-sm font-medium text-red-600 hover:text-red-800">
                    Ver detalle <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg>
                </a>
    ...
    <div class="bg-white rounded-xl shadow-sm mb-6 overflow-hidden border border-gray-100">
        ...
        <div class="p-6">
            <form action="{{ route('institucion.solicitudes.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Clase asignada</th>
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex space-x-2">
                                            <a href="{{ route('institucion.solicitudes.show', $solicitud->id) }}" class="bg-blue-100 text-blue-700 hover:bg-blue-200 rounded-lg p-2 transition-colors">
